  ...
  return (
    <div className={`w-full ${className}`}>
      ...
      <input
        ...
        className={`  w-full border-2 border-gray-200   mt-1 p-3 !pl-5 !py-2.5   focus:ring-primary outline-none focus:border-primary block  shadow-sm sm:text-sm  rounded-full ${styleInput}  ${
